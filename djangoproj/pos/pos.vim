...
silent only
cd ~/djangoproj/pos/invoices/templates/invoices
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +69 ~/djangoproj/pos/invoices/models.py
badd +43 ~/djangoproj/pos/invoices/forms.py
badd +27 ~/djangoproj/pos/invoices/urls.py
badd +82 ~/djangoproj/pos/invoices/views.py
badd +1 ,
badd +35 seznam_skupin_artiklov.html
badd +49 seznam_racunov.html
badd +56 base.html
badd +0 ~/djangoproj/pos/invoices/static/invoices/app_design.css
badd +21 racun_add.html
badd +18 racun_preview.html
args ~/djangoproj/pos/invoices/models.py
edit ~/djangoproj/pos/invoices/forms.py
...
silent! normal! zE
let s:l = 87 - ((33 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
normal! 09|
lcd ~/djangoproj/pos/invoices
tabedit ~/djangoproj/pos/invoices/templates/invoices/racun_add.html
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
24
normal! 024|
tabedit ~/djangoproj/pos/invoices/static/invoices/app_design.css
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((41 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
normal! 017|
lcd ~/djangoproj/pos/invoices/static/invoices
tabnext 1
if exists('s:wipebuf')
