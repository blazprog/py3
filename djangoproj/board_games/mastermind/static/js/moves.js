...
$(document).ready(function() {
    solution = [
        $('#solution1').data('piece'),
        $('#solution2').data('piece'),
        $('#solution3').data('piece'),
        $('#solution4').data('piece')
    ];
    
    $('#pb_solution').on('click', function(ev) {
        $('.puzzle-solution').toggle();
        if ($('.puzzle-solution').is(':visible')) {
            $('#pb_solution').attr('value', 'Hide solution');
        }
        else {
            $('#pb_solution').attr('value', 'Show solution');
        }
    });
